...
class GroupListFragment : Fragment(), CreateGroupListener {
    ...
    var contactList: List<Groups> = ArrayList()
    ...
    private fun initRecyclerView(quoteItem: List<Groups>) {
        ...
        val contactAdapter = GroupListAdapter(quoteItem, requireContext(), viewModel)
        recyclerview.apply {
